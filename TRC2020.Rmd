...
distance.folder <- file.path(dir,"fs",length(series),"distance",288,maxlag)
...
results <- readRDS(file.path("STAR_TRC2020_fs_64_RF_20160_3_2017-10-08_000000_rds_10080_3_FALSE_0_2_TRUE.rds"))
...
s<-cvSummary(r1, mae, cumulative=F, params=params)%>%
